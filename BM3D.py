...
def BM3D_1st_step(_noisyImg):
    ...
    for i in range(int(Width_num+2)):
        for j in range(int(Height_num-3)):
...
if __name__ == '__main__':
    ...
    cv2.imwrite("C:/Users/limengyang/Desktop//Final3.jpg", Final_img)
    # img_name = os.listdir("C:/Users/limengyang/Desktop/VAnoise")   # 图像的路径
    # img_name0 = os.listdir("C:/Users/limengyang/Desktop/VAdenoise")  # 图像的路径
    # for i in range(len(img_name )):
    #     print(i)
    #     img = cv2.imread("C:/Users/limengyang/Desktop/VAnoise//" + img_name[i], cv2.IMREAD_GRAYSCALE)  # 读入图像，cv2.IMREAD_GRAYSCALE:以灰度模式读入图像
    #     img0 = cv2.imread("C:/Users/limengyang/Desktop/VAdenoise//" + img_name0[i], cv2.IMREAD_GRAYSCALE)  # 读入图像，cv2.IMREAD_GRAYSCALE:以灰度模式读入图像
    #     # 记录程序运行时间
    ...
    #     cv2.imwrite("./BM3DRESULT/Basic3.jpg", Basic_img)
    #     psnr1 = psnr(img0, Basic_img)
    #     ssim1 = ssim(img0, Basic_img)
    #     print("The PSNR between the two img of the First step is %f" % psnr1)
    #     print("The SSIM between the two img of the First step is %f" % ssim1)
    ...
    #     cv2.imwrite("./BM3DRESULT/Final3.jpg", Final_img)
    #     psnr2 = psnr(img0, Final_img)
    #     ssim2 = ssim(img0, Final_img)
    #     print("The PSNR between the two img of the Second step is %f" % psnr2)
    #     print("The SSIM between the two img of the First step is %f" % ssim2)
